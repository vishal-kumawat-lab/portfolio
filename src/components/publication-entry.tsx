  ...
  return (
    <div className="flex flex-col sm:flex-row gap-6">
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="flex flex-row gap-6">
          {publication.paperUrl && (
            ...
            >
              ...
              />
              <span className="tracking-wider uppercase">ci code</span>
            </a>
          )}
          {publication.codeUrl && (
            <a
            ...
            >
              <ArrowUpRight
                ...
                className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-300"
              />
              <span className="tracking-wider uppercase">cd code</span>
            </a>
          )}
          {publication.bibtex && (
            <a
        ...
        {publication.tldr && (
          <p className="whitespace-pre-line text-sm text-zinc-600 mt-4">
            {publication.tldr}
          </p>
        )}
      </div>
